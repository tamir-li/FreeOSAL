    ...
    for(;;)
  	{
        ...
        do
        {
            if(g_osal_rt_signalfifo_ctl.front != g_osal_rt_signalfifo_ctl.rear)
            {
                osal_signal_t temp_rt_signal = g_osal_rt_signalfifo[g_osal_rt_signalfifo_ctl.rear];
        ...
        if(g_osal_signalfifo_ctl.front != g_osal_signalfifo_ctl.rear)
        {
            osal_signal_t temp_signal = g_osal_signalfifo[g_osal_rt_signalfifo_ctl.rear];
...
void osal_signal_emit(osal_signal_id_t signal, osal_size_t parm)
{
    ...
    g_osal_signalfifo_cache[g_osal_signalfifo_cache_ctl.front].signal = signal;
    g_osal_signalfifo_cache[g_osal_signalfifo_cache_ctl.front].parm = parm;
...
void osal_rt_signal_emit(osal_signal_id_t signal, osal_size_t parm)
{
    ...
    g_osal_rt_signalfifo_cache[g_osal_rt_signalfifo_cache_ctl.front].signal = signal;
    g_osal_rt_signalfifo_cache[g_osal_rt_signalfifo_cache_ctl.front].parm = parm;
...
void osal_loop(void)
{
	...
	{
		osal_task_process();
		_portosal_task_hooks();
		osal_idle_handle();
		// _portosal_softirq_entry();
